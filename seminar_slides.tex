...
\renewcommand{\logosinfootline}{\raisebox{0.12cm}{\begin{beamercolorbox}{rafi}{Seminar \quad Word embedding \hfill \insertframenumber/\inserttotalframenumber}\end{beamercolorbox}}}

\begin{frame}[allowframebreaks]
    \frametitle{Agenda}
    \tableofcontents
    %spaces will become smaller with more subsections
\end{frame}
...
\input{./fragments/slides-seminar-topic}
...
% bibliography included in the file with slides, because other way slides number were countted wrongly
